...
module.exports = {
    auth: function (req: express.Request, res: express.Response, next: express.NextFunction): any {
    ...
    verifyAdmin: function (req: express.Request, res: express.Response, next: express.NextFunction): any {
    ...
    verifynotasync: function (token: string): any {
        return jwt.verify(token, config.secretKey, function (err: any, decoded: any) {
            if (err) {
                return err;
            } else {
